...
<Update label="May 15, 2026" tags={["Invoices"]}>
  <Badge color="yellow">Beta</Badge> <Badge>Invoices</Badge> The Invoices endpoints are now labeled as **beta**. Expect refinements while the feature stabilizes — let us know what works and what doesn't.
